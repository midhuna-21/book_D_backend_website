...
export interface IUserService {
   ...
   getUpdateProfileImage( userId: string,imageUrl: string): Promise<IUser | null>;
   getSaveToken(userId: string,resetToken: string,resetTokenExpiration: number): Promise<IUser | null>;
   getUserByPhone(phone: string): Promise<IUser | null>;
   getUserByPhone(phone: string): Promise<IUser | null>;
