...
export class CartService{
     ...
     async getCheckRequest(userId:string,bookId:string):Promise<ICart | null>{
        try{
    ...
    // async getUpdateRequest(cartId:string){
    //     try{
    //         return await cartRepository.findUpdateCart(cartId)
    //     }catch(error){
