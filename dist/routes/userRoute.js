...
userRouter.post("/update-order-status-from-lender/:selectedOrderId", authMiddleware_1.verifyToken, bookController_1.updateOrderStatusLender);
userRouter.get("/wallet", authMiddleware_1.verifyToken, WalletController_1.walletTransactions);
userRouter.post("/payment-wallet", authMiddleware_1.verifyToken, WalletController_1.paymentWallet);
userRouter.post("/check-wallet", authMiddleware_1.verifyToken, WalletController_1.checkWallet);
